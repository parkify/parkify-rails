...
describe "offer_schedule_exceptions/new" do
  before(:each) do
    assign(:offer_schedule_exception, stub_model(OfferScheduleException,
      :resource_offer_id => 1,
  ...
  it "renders new offer_schedule_exception form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => offer_schedule_exceptions_path, :method => "post" do
